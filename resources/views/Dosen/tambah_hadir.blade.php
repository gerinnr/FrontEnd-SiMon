...
<head>
    ...
    <title>Tambah Data Kehadiran - SiMON</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-5 overflow-y-auto">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto mt-8">
                <h2 class="text-2xl font-bold text-center mb-6">Tambah Data Kehadiran</h2>
                ...
                <form action="{{ route('dosen.hadir.store') }}" method="POST">
                    @csrf
                    ...
                    <!-- Mata Kuliah -->
                    <label class="block mb-2 font-medium">Pilih Mata Kuliah</label>
                    ...
                    <!-- Dosen -->
                    <label class="block mb-2 font-medium">Dosen (NIDN)</label>
                    ...
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded w-full hover:bg-blue-600 transition duration-200">Tambah Data</button>
                </form>
