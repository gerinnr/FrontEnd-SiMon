    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-5">
            ...
            <div class="max-w-4xl mx-auto bg-white p-4 rounded-lg shadow-md mt-6">
                ...
                <!-- Form Tambah Data -->
                <a href="/dosen/tambah_datahadir" class="bg-blue-500 text-white px-4 py-2 rounded-lg w-20 text-center">Tambah</a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border p-2 text-center">
                                    <button><a href="/dosen/edit_datahadir" class="bg-yellow-500 text-white px-2 py-1 rounded inline-block">Edit</a></button>
                            ...
                            <tr>
                                ...
                                <td class="border p-2">Dewi Lestari</td>
                                <td class="border p-2 text-center">4</td>
