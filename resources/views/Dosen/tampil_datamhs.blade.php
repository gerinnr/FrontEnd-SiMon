    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-5">
            ...
            <div class="max-w-4xl mx-auto bg-white p-4 rounded-lg shadow-md mt-6">
                ...
                <!-- Form Tambah Data -->
                <a href="/dosen/tambah_datamhs" class="bg-blue-500 text-white px-4 py-2 rounded-lg w-20 text-center">Tambah</a>
                    ...
                    <table class="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <button><a href="/dosen/edit_datamhs" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit</a></button>
