        ...
        <div class="flex-1 p-5 flex flex-col">
            ...
            <div class="flex justify-center items-center flex-grow">
                <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                    ...
                    <form action="{{ route('admin.kls.store') }}" method="POST">
                        @csrf

                        <label class="block mb-2">Kode Kelas</label>
                        <input type="text" name="kode_kelas" value="{{ old('kode_kelas') }}"
                            class="w-full p-2 border rounded mb-4 @error('kode_kelas') border-red-500 @enderror" required>
                        @error('kode_kelas')
                        ...
                        <input type="text" name="nama_kelas" value="{{ old('nama_kelas') }}"
                            class="w-full p-2 border rounded mb-4 @error('nama_kelas') border-red-500 @enderror" required>
                        @error('nama_kelas')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
