<!-- resources/views/admin/hadir/create.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
            ...
            <div class="flex justify-center items-center flex-grow">
                <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                    ...
                    <form action="{{ route('admin.hadir.store') }}" method="POST">
                        ...
                        <select name="npm" id="npm" class="w-full p-2 border rounded mb-4" onchange="isiNama()" required>
                            <option value="">-- Pilih NPM --</option>
                            @foreach ($mahasiswa as $mhs)
                                <option value="{{ $mhs['npm'] }}" data-nama="{{ $mhs['nama_mahasiswa'] }}" {{ old('npm') == $mhs['npm'] ? 'selected' : '' }}>
                        ...
                        <input type="date" name="tanggal" class="w-full p-2 border rounded mb-4" value="{{ old('tanggal') }}" required>

                        <label class="block mb-2">Pertemuan</label>
                        <input type="number" name="pertemuan" class="w-full p-2 border rounded mb-4" value="{{ old('pertemuan') }}" required>
                        ...
                        <select name="kode_matkul" class="w-full p-2 border rounded mb-4" required>
                        ...
                        <select name="nidn" class="w-full p-2 border rounded mb-4" required>
