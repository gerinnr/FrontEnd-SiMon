                ...
                <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                    ...
                    <form action="{{ route('admin.dosen.store') }}" method="POST">
                        ...
                        <input type="number" name="nidn" value="{{ old('nidn') }}"
                            class="w-full p-2 border rounded mb-4 @error('nidn') border-red-500 @enderror" required autofocus>
                        @error('nidn')
                        ...
                        <select name="id_user"
                            class="w-full p-2 border rounded mb-4 @error('id_user') border-red-500 @enderror" required>
